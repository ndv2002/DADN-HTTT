...
/*public class MQTTHelper {
    ...
    //final String subscriptionTopic = "baokhanhle123/feeds/+";
    //final String username = "baokhanhle123";
    final String username = "xMysT";
    final String subscriptionTopic = "xMysT/feeds/button1";
...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"dlhcmut/feeds/bbc-led", "dlhcmut/feeds/bbc-fan"};

    final String clientId = "12345789";
    final String username = "dlhcmut";
    final String password = "aio_DSdv08B4n07hxZDuifw02Rsil40e";
